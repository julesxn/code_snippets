<div id="editBillingModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="icon close" data-dismiss="modal">Close</div>
        <div class="modal-content">
            <h2 class="title">Edit billing address</h2>
            ...
            <div class="checkbox-wrapper">            
                <input type="checkbox" id="check-update-billing" class="checkbox-radio">
                <label for="check-update-billing">

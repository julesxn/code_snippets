<div id="duplicateModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <h2 class="title">Duplicate Order</h2>

            <p style="margin-bottom: 20px;">
                This will duplicate the order exactly <span class="strong">without</span> charging the client.<br>
                Please correct the address and items in the order before approving it.
            </p>
            ...
            <table class="orders-list" style="margin-top: 20px;">
                ...
                <tr>
                    ...
                    <td class="col-3 price text-right">$20.00 <span class="icon remove"></span</td>
                </tr>
                <tr>
                    <td class="col-1 product">10 Volume Single Developer (new)</td>
                    <td class="col-2 qty text-center">1</td>
                    <td class="col-3 price text-right">$0.00 <span class="icon remove"></span</td>
                </tr>
                <tr>
                    <td class="col-1 product">Anti-Friz Hair Serum</td>
                    <td class="col-2 qty text-center">1</td>
                    <td class="col-3 price text-right">$18.00 <span class="icon remove"></span></td>
                </tr>
                <tr>
                    <td></td>
                    <td class="col-2 qty">

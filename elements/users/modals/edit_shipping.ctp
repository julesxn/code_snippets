<div id="editShippingModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="icon close" data-dismiss="modal">Close</div>
        <div class="modal-content">
            <h2 class="title">Edit shipping address</h2>

            <div class="form-width-5" style="margin-top: -10px">
                ...
                <div class="form-group floating-label-form-group">
                    ...
                    <input name="" type="text" class="form-control" required="1" placeholder="Phone Number" value="888-888-8888" maxlength="30" id="">                
                </div>
            </div>

            <div class="checkbox-wrapper">            
                <input type="checkbox" id="check-update-shipping" class="checkbox-radio">
                <label for="check-update-shipping">
                    <span class="check"></span>
                    Update client's account
                </label>
            </div>

            <button class="cta-btn btn-mainBlue md">Save changes</button>
